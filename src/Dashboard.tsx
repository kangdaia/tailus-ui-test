    ...
    <>
      <div className="w-full lg:flex lg:[grid-template-columns:auto_1fr]">
        ...
        <main
          data-shade="900"
          className={twMerge(
            'relative h-screen overflow-auto border-x bg-[--ui-bg] transition-transform duration-300 lg:ml-[18rem] lg:mr-1 lg:mt-1 lg:h-[calc(100vh-4px)] lg:w-[calc(100vw-18rem)] lg:rounded-t-[--card-radius] lg:border-t lg:shadow-md lg:shadow-gray-600/10',
